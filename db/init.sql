...
ALTER TABLE IF EXISTS public.student DROP CONSTRAINT IF EXISTS student_id_fkey;

ALTER TABLE IF EXISTS public.instructor DROP CONSTRAINT IF EXISTS instructor_id_fkey;
...
ALTER TABLE IF EXISTS public.student
    ADD CONSTRAINT student_id_fkey FOREIGN KEY (id)
...
ALTER TABLE IF EXISTS public.instructor
    ADD CONSTRAINT instructor_id_fkey FOREIGN KEY (id)
    REFERENCES public."user" (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
    NOT VALID;
