...
export default function StudentCourses() {
  ...
  useEffect(() => {
    // Load courses from localStorage (created by teachers)
    setCourses(getCourses());
  }, []);

  /* Old mock courses - removed
  const mockCourses: Course[] = [
    ...
    },
    {
      ...
      thumbnail:
        "https://topdev.vn/blog/wp-content/uploads/2024/07/cac-kieu-du-lieu-trong-typescript-ma-ban-nen-biet.png",
...

    {
      ...
      thumbnail:
        "https://blog.nashtechglobal.com/wp-content/uploads/2025/08/O-que-e-Tailwind-CSS-e-por-que-ele-virou-tendencia-no-front-end_-Programadores-Depre-Programacao-e-Tecnologia.jpeg",
  ...
  */
  ...
  // State openView, selectedCourse removed - now navigate to detail page
      ...
      <Card title="Available Courses">
        {courses.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10">
            {courses.map((course) => (
              <CourseCard key={course.id} course={course} onClick={() => handleView(course)} />
            ))}
          </div>
        )}
      </Card>
